...
class _LoginState extends State<Login> {
  ...
  login() async {
    final response = await http
        .post("http://13.235.139.116/Lakhimpur/openapi/getUserByIdAndPassword", body: {
      //"flag": 1.toString(),
      "userId": email,
      "password": password,
...
//            color: Colors.grey.withAlpha(20),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Image.network(
                              "https://static.wixstatic.com/media/e12f34_6a5bb6261ec440fd80424b1e8a427473~mv2.png/v1/fill/w_297,h_239,al_c,q_80,usm_0.66_1.00_0.01/Modistabox%20logo%20white%20text.webp"),
                          SizedBox(
                            height: 40,
                          ),
                          SizedBox(
...
class _RegisterState extends State<Register> {
  ...
  save() async {
    final response = await http
        .post("http://13.235.139.116/Lakhimpur/openapi/registerVendor", body: {
      "vendorName": name,
      "companyName": name,
      "email": email,
